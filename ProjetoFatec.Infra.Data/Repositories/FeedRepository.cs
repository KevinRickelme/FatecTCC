...
namespace ProjetoFatec.Infra.Data.Repositories
{
    public class FeedRepository : IFeedRepository
    {
        ...
        public async Task<Feed> GetFeed(int IdPerfil)
        {
            ...
            feed.Publicacoes = _context.Publicacoes.Where(p => p.IdPerfil == feed.IdPerfil || IdAmigos.Contains(p.IdPerfil)).Include(nameof(Perfil)).OrderByDescending(p=>p.DataCriacao).ToList();
