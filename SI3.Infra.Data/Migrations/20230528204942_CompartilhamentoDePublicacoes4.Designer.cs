...
namespace SI3.Infra.Data.Migrations
{
    ...
    [Migration("20230528204942_CompartilhamentoDePublicacoes4")]
    partial class CompartilhamentoDePublicacoes4
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SI3.Domain.Entities.Amigo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SI3.Domain.Entities.Comentario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SI3.Domain.Entities.Curtida", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SI3.Domain.Entities.Feed", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SI3.Domain.Entities.Foto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SI3.Domain.Entities.FotoPerfil", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SI3.Domain.Entities.Perfil", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SI3.Domain.Entities.Publicacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SI3.Domain.Entities.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SI3.Domain.Entities.Amigo", b =>
                {
                    b.HasOne("SI3.Domain.Entities.Perfil", "PerfilSolicitante")
                        .WithMany("Amigos")
            ...
            modelBuilder.Entity("SI3.Domain.Entities.Comentario", b =>
                {
                    b.HasOne("SI3.Domain.Entities.Perfil", "Perfil")
                        .WithMany("Comentarios")
                        .HasForeignKey("IdPerfil")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SI3.Domain.Entities.Publicacao", "Publicacao")
                        .WithMany("Comentarios")
            ...
            modelBuilder.Entity("SI3.Domain.Entities.Perfil", b =>
                {
                    b.HasOne("SI3.Domain.Entities.Feed", "Feed")
                        .WithOne("Perfil")
                        .HasForeignKey("SI3.Domain.Entities.Perfil", "IdFeed");

                    b.HasOne("SI3.Domain.Entities.FotoPerfil", "FotoPerfil")
                        .WithOne("Perfil")
                        .HasForeignKey("SI3.Domain.Entities.Perfil", "IdFotoPerfil");

                    b.HasOne("SI3.Domain.Entities.Usuario", "Usuario")
                        .WithOne("Perfil")
                        .HasForeignKey("SI3.Domain.Entities.Perfil", "IdUsuario")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SI3.Domain.Entities.Publicacao", b =>
                {
                    b.HasOne("SI3.Domain.Entities.Feed", null)
                    ...
                    b.HasOne("SI3.Domain.Entities.Perfil", "PerfilQueCompartilhou")
                        .WithMany("PublicacoesCompartilhadas")
                        .HasForeignKey("IdPerfilQueCompartilhou")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("SI3.Domain.Entities.Publicacao", "PublicacaoOriginal")
                        .WithMany()
